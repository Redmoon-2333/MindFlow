...
class TestAutonomyService:
    ...
    async def test_enabled_when_no_autonomy_key(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
    ...
    async def test_paused_when_paused_until_future(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
    ...
    async def test_paused_until_expired(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
    ...
    async def test_paused_until_naive_tz(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
    ...
    async def test_invalid_paused_until(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
    ...
    async def test_pause_sets_paused_until(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
    ...
    async def test_pause_enforces_minimum(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
    ...
    async def test_resume_clears_paused_until(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
    ...
    async def test_resume_preserves_enabled(
        self, service: AutonomyService, mock_prefs: MagicMock
    ) -> None:
